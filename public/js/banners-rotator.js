(function(_window){
    ...
    bannersRotator.createBanner = function (params) {
        if (this.isBannerShouldBeShown(params.id) && this.isFirstByType(params.type)) {
            try {
    ...
    bannersRotator.isFirstByType = function (type) {
        for (var i=0, max=this.instances.length; i < max; i += 1) {
    ...
    _window.bannersRotator = bannersRotator;
    _window.bannersRotator.Banner = Banner;
