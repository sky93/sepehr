    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
               ...
               <!-- Form Name -->
               <legend>{{ Lang::get('messages.home.title') }}</legend><br />
               ...
               <div class="form-group">
                 <label class="col-md-4 control-label" for="link">{{ Lang::get('messages.link.to.transload') }}</label>
                 <div class="col-md-5">
               ...
               <div class="form-group">
                ...
                <div id="HTTP" style="display: none;">
                   <!-- HTTP User input-->
                   <div class="form-group">
                     <label class="col-md-4 control-label" for="http_username">{{ Lang::get('messages.http.username') }}</label>
                     <div class="col-md-2">
                   ...
                   <!-- HTTP Password input-->
                   <div class="form-group">
                     <label class="col-md-4 control-label" for="http_password">{{ Lang::get('messages.http.password') }}</label>
                     <div class="col-md-2">
               ...
               <!-- Comment -->
               <div class="form-group">
                 <label class="col-md-4 control-label" for="comment">{{ Lang::get('messages.comment') }}</label>
                 <div class="col-md-4">
               ...
               <div class="form-group">
                 ...
                 <div class="col-md-1">
                   <button id="transload" name="transload" class="btn btn-primary">{{ Lang::get('messages.transload') }}</button>
                 </div>
               </div>
