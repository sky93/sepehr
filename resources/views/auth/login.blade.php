    ...
    <div class="col-md-8 col-md-offset-2">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                @endif
                <img style="display: block; margin-left: auto; margin-right: auto; border-radius: 5px; -webkit-border-radius: 5px;-moz-border-radius: 5px;" class="img-responsive" src="{{ url('/img/login_logo.png') }}"><hr/>
